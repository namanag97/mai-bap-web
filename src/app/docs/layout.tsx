...
export default function DocsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="pt-14 min-h-screen bg-surface-ground">
      ...
      <div className="lg:hidden border-b border-border-default bg-surface-ground px-6 h-11 flex items-center">
        <button
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-40 pt-[calc(56px+44px)]">
          <div className="absolute inset-0 bg-surface-inverse/20" onClick={() => setSidebarOpen(false)} />
          <div className="relative max-h-[calc(100vh-100px)] max-w-xs bg-surface-ground border-r border-border-default overflow-y-auto">
